...
const AccountContent = () => {
  ...
  return (
    <div className='relative min-h-screen bg-[#111113] pt-32 md:pt-60 pb-24 px-6 md:px-45 flex flex-col items-center gap-16 overflow-hidden'>
      ...
      {/* Profile Card */}
      <div className='bg-[#111113] rounded-3xl p-8 w-full max-w-xl'>
        ...
        <div className='flex flex-col gap-5'>
          ...
          {/* Delete Account */}
          <button className='block mx-auto w-48 bg-red-600 hover:bg-red-500 text-white text-xs tracking-widest uppercase py-2 rounded-full transition duration-200 mt-2'>
            Delete Account
          </button>
      ...
      <div className='w-full'>
        ...
        {/* Game Card */}
        <div className='bg-[#1c1c1e] rounded-3xl p-5 flex items-end gap-5 w-full md:w-72'>
          <img
            src={FriendThumb}
            alt='The Friend'
          ...
          <div className='flex flex-col gap-3'>
            <p className='font-spartan text-white font-semibold text-lg md:text-2xl'>The Friend</p>
            <button
              onClick={() => navigate('/friend')}
              className='bg-[#f16d18] hover:bg-[#d45e10] text-white text-xs tracking-widest uppercase px-4 py-1.5 rounded-full transition duration-200'
            >
              Play Game
            </button>
          </div>
