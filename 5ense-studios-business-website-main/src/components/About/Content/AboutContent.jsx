...
const AboutContent = () => {
  return (
    <div id="about-content" className="relative flex items-center bg-[#1F2021] px-6 md:px-45 py-32 overflow-hidden">
      ...
      <div className="w-full relative z-10">
        ...
        <p className="text-white text-lg md:text-2xl leading-relaxed text-justify mb-12">
